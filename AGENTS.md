...
- `src/components/shell/pull-to-refresh.tsx` — the per-tab pull-to-refresh indicator, refresh lifecycle, and status announcement; `pull-gesture.ts` holds the touch state machine it drives.
